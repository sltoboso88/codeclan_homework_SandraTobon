...
```
1.8 read lines can accept multiples files with the direction of the path and in this way you can read lines of text into a multi-element text vector?
1.9
```{r}
